...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_welcome'] = sprintf($this->language->get('text_welcome'), $this->url->link('account/login', '', 'SSL'), $this->url->link('account/register', '', 'SSL'), $this->url->link('account/register-seller', '', 'SSL'));
		...
		$this->data['text_category'] = $this->language->get('text_category');
				if ($this->MsLoader->MsSeller->isCustomerSeller($this->customer->getId())) {
					$this->data['home'] = $this->url->link('seller/account-dashboard');
				} else {
		$this->data['home'] = $this->url->link('common/home');
				}

		$this->data['bids'] = $this->url->link('seller/account-dashboard/allsellerbids');
		$this->data['subscribe'] = $this->url->link('product/main');
		$this->data['product_list'] = $this->url->link('seller/account-product');
		$this->data['members'] = $this->url->link('account/addmember');
		$this->data['mybidlist'] = $this->url->link('product/mybidlist');
		$this->data['mybid'] = $this->url->link('product/mybid');
		$this->data['basket'] = $this->url->link('product/basket');
